...
- Now, import the codexstester library into the pom.xml file of any project the following dependency:
...
Going to the direct point, we are show some examples for Codexstester use case tests, you can see all these tests in 
