...
public abstract class ExternalRequest3xxTests extends ExternalRequest4xxTests {
    ...
    public void isOk3xxTest() {
        System.out.println("Test 3xx is OK !");
        assertionTest("test3xx", "test3xx");
    }

    /**
     * STATUS CODE 300 (MULTIPLE_CHOICE_300) TESTS
     * */
    public void codexsTester_StatusCode300_RetrieveMultipleChoice(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode301_RetrieveMovedPermanently(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode302_RetrieveFound(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode303_RetrieveSeeOther(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode304_RetrieveNotModified(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode305_RetrieveUseProxyDeprecated(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode306_RetrieveUnusedDeprecated(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode307_RetrieveTemporaryRedirect(HeadersDto headersDto, RequestDto requestDto) throws Exception {
     ...
     * */
    public void codexsTester_StatusCode308_RetrievePermanentRedirect(HeadersDto headersDto, RequestDto requestDto) throws Exception {
