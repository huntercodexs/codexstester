...
import codexstester.core.internal.InternalHttpHeadersFactory;
...
public abstract class ExternalHttpHeadersFactory extends InternalHttpHeadersFactory {
    ...
    protected static ResponseEntity<Object> codexsTesterExternalOAuth2CheckToken(Oauth2RequestCheckTokenDto oauth2RequestCheckTokenDto) {
        ...
        if (oauth2RequestCheckTokenDto.getAdditionalName() != null && !oauth2RequestCheckTokenDto.getAdditionalName().equals("")) {
            if (oauth2RequestCheckTokenDto.getAdditionalValue() != null && !oauth2RequestCheckTokenDto.getAdditionalValue().equals("")) {
                httpHeaders.set(oauth2RequestCheckTokenDto.getAdditionalName(), oauth2RequestCheckTokenDto.getAdditionalValue());
            }
        }
