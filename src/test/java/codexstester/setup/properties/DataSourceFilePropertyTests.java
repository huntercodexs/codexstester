package codexstester.setup.properties;

public class DataSourceFilePropertyTests {
    ...
    /*Sample*/
    protected static String externalPropertiesFilepath = "sample/external.tests.properties";
    protected static String internalPropertiesFilepath = "sample/internal.tests.properties";
    protected static String unitaryPropertiesFilepath = "sample/unitary.tests.properties";
