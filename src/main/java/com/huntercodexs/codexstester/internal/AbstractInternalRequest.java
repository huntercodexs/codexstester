...
import com.huntercodexs.codexstester.http.AvailableHttpMethod;
...
public abstract class AbstractInternalRequest extends AvailableHttpMethod {

    protected AbstractInternalRequest(String target) {
        super(target);
    }
    ...
    private void dispatcher(RequestDto requestDto, HeadersDto headersDto, String method) throws Exception {
        ...
        String aType = headersDto.getAcceptable();
        ...
        try {
            ...
            codexsHelperLogTerm("INTERNAL RESPONSE IS", String.valueOf(result.getResponse()), true);
