...
public abstract class AbstractInternalMockMvc extends AbstractInternalRequest {

    protected AbstractInternalMockMvc(String target) {
        super(target);
    }
    ...
    protected String codexsTesterInternalDispatcher(RequestDto requestDto, HeadersDto headersDto) {
        ...
        String url = internalUrlBaseTest
                .replaceFirst("/$", "") +"/"+
                uri.replaceFirst("^/", "");
