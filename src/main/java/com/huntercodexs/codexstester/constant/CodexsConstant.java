...
public enum CodexsConstant {
    ...
    CODEXS_JWT_HS256("^([0-9a-zA-Z]{20}|[0-9a-zA-Z]{36})\\.([0-9a-zA-Z]{74}|[0-9a-zA-Z]{90})\\.([0-9a-zA-Z_-]{43})$"),
    CODEXS_JWT_HS384("^([0-9a-zA-Z]{20}|[0-9a-zA-Z]{36})\\.([0-9a-zA-Z]{90,91})\\.([0-9a-zA-Z-_]{64})$"),
    CODEXS_JWT_HS512("^([0-9a-zA-Z]{20,36}\\.[0-9a-zA-Z]{90,91}\\.[0-9a-zA-Z_-]{86})$"),
