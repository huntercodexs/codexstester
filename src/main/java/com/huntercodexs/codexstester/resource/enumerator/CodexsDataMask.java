...
public enum CodexsDataMask {
    ...
    CodexsDataMask(String pattern, String replace, int repeat) {
    ...
    private static String defaultMask(String input, CodexsDataMask dataMasked) {
     ...
     * */
    public static String dataMasked(String data, String mask, CodexsDataMask dataMasked) {
        ...
        if (result.equals(data)) {
            System.out.println("dataMasked say: Nothing to do ["+result+"]");
        }

        if (dataMasked.name().equals(CodexsDataMask.CPF_NUMBER_DIGIT_MASK.name())) {
