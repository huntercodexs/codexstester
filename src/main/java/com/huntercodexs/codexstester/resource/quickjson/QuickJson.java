package com.huntercodexs.codexstester.resource.quickjson;

import com.huntercodexs.codexstester.resource.quickjson.core.QuickJsonData;
import com.huntercodexs.codexstester.resource.quickjson.core.QuickJsonExtractor;
...
public class QuickJson {
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">add</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">addAll</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">remove</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">clear</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">update</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">get</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">getObject</p>
     *
     * <p style="color: #CDCDCD">Retrieve one specific field value informing the field name</p>
     *
     * <p>Example</p>
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">create</p>
     *
     * <p style="color: #CDCDCD">
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">json</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">merge</p>
     *
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">print</p>
     *
     * <p style="color: #CDCDCD">
    ...
    /**
     * <p style="color: #FFFF00; font-size: 11px; weight: bold">prettify</p>
     *
