package com.huntercodexs.codexstester.http;

import com.huntercodexs.codexstester.dto.RequestDto;
import com.huntercodexs.codexstester.external.ExternalHttpHeadersFactory;
import org.springframework.test.web.servlet.ResultMatcher;

import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;

public abstract class AvailableHttpStatus extends ExternalHttpHeadersFactory {
    ...
    protected AvailableHttpStatus(String target) {
        super(target);
    }
