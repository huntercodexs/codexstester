package com.huntercodexs.codexstester.properties;

import com.huntercodexs.codexstester.ignition.CodexTesterPropertiesLoader;

public abstract class UnitaryProperty extends CodexTesterPropertiesLoader {
    ...
    protected UnitaryProperty(String target) {
        super(target);
    }
